...
import ch.usi.inf.l3.piuma.util.Utilities
import ch.usi.inf.l3.piuma.util.SymbolsUtil
import ch.usi.inf.l3.piuma.util.TypesUtil
import ch.usi.inf.l3.piuma.util.TreesUtil
import ch.usi.inf.l3.piuma.util.SymbolsUtil
import ch.usi.inf.l3.piuma.util.StoreScopeCake
// import scala.tools.nsc.symtab._
import ch.usi.inf.l3.piuma.util.ScopeCake

abstract class PiumaPlugin(val global: Global)
  extends Plugin
  with SymbolsUtil 
  with TreesUtil
  with TypesUtil

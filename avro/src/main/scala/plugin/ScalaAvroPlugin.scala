...
trait ScalaAvroPluginComponent extends PluginComponent {
  ...
  protected lazy val MapClass = rootMirror.getClassByName(newTypeName("scala.collection.immutable.Map"))

  /** Avro Scala Plugin Traits */
  protected lazy val avroRecordTrait = rootMirror.getClassByName(newTypeName("com.googlecode.avro.marker.AvroRecord"))
  protected lazy val avroUnionTrait = rootMirror.getClassByName(newTypeName("com.googlecode.avro.marker.AvroUnion"))

  /** Avro Extra Primitive Types */
  protected lazy val byteBufferClass = rootMirror.getClassByName(newTypeName("java.nio.ByteBuffer"))
  protected lazy val utf8Class = rootMirror.getClassByName(newTypeName("org.apache.avro.util.Utf8"))

  /** Avro Internal Types */
  protected lazy val GenericArrayClass = rootMirror.getClassByName(newTypeName("org.apache.avro.generic.GenericArray"))
  protected lazy val schemaClass = rootMirror.getClassByName(newTypeName("org.apache.avro.Schema"))
  protected lazy val SpecificRecordIface = rootMirror.getClassByName(newTypeName("org.apache.avro.specific.SpecificRecord"))
  protected lazy val SpecificRecordBaseClass = rootMirror.getClassByName(newTypeName("org.apache.avro.specific.SpecificRecordBase"))
  protected lazy val JMapClass = rootMirror.getClassByName(newTypeName("java.util.Map"))

  /** Scala Avro Internal types */
  protected lazy val ScalaSpecificRecord = rootMirror.getClassByName(newTypeName("com.googlecode.avro.runtime.ScalaSpecificRecord"))
  protected lazy val AvroConversions = rootMirror.getClassByName(newTypeName("com.googlecode.avro.runtime.HasAvroConversions"))
  protected lazy val GenericArrayWrapperClass = rootMirror.getClassByName(newTypeName("com.googlecode.avro.runtime.GenericArrayWrapper"))

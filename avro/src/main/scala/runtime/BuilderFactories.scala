...
trait HasMutableBuilders {
  ...
  // implicit def scala$collection$mutable$DoubleLinkedListFactory[E] = new BuilderFactory[E, scala.collection.mutable.List[E]] {
  //   def newBuilder = Nil
  // }
  ...
  // implicit def scala$collection$mutable$LinkedListFactory[E] = new BuilderFactory[E, List[E]] {
